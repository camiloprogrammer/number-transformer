...
import number.transformer.core.internal.spanish.BillionTransformer;
import number.transformer.core.internal.spanish.SignTransformer;
import number.transformer.core.internal.spanish.ZeroTransformer;

/**
 * An implementation of a {@link NumberToTextTransformer} that transforms numbers into their Spanish
 * textual representation.
 */
public class NumberToSpanishTextTransformer implements NumberToTextTransformer {

    private static final String NEGATIVE_ZERO = "-0";

    private final IntNumberTransformer transformer;

    public NumberToSpanishTextTransformer() {
        this.transformer = new ZeroTransformer(new SignTransformer(new BillionTransformer()));
    }

    /**
     * Transforms the input <code>String</code> number into its Spanish textual representation.
     * 
     * <p>
     * For example:
     * <ul>
     * <li><code>"1"</code> to <code>"Uno"</code>
     * <li><code>"-11"</code> to <code>"Menos once"</code>
     * </ul>
     * 
     * <p>
     * Valid inputs:
